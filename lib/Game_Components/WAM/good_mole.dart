...
class GoodMole extends SpriteAnimationComponent with HasGameReference<WhackAMole>, TapCallbacks {
  ...
  void onTapDown(TapDownEvent event) {
    ...
    if (currentFrame >= whackFrameRange[0] && currentFrame <= whackFrameRange[1]) {
      ...
      // print("GoodMole whacked! Starting whack animation");
    }
  }
  ...
  void show() {
    ...
    // print("Showing GoodMole at position: $position");
